              ...
              if (is_object($planningCmd)) {
                ...
                foreach( $planning as $value){
                 ...
                 // ajout double plannif
                  ...
                  echo '<td><input id="startTime'.$count.'" class="form-control" type="time" value="'.$detail[3].'"></td>';
                  echo '<td><input id="duration'.$count.'" class="form-control" type="number" value="'.$detail[4].'"></td>';
                  echo '<td><input id="edge'.$count.'" class="form-control" type="checkbox" '.$checked.'></td>';
